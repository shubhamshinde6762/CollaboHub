...
const UserPanel = ({ user, allDetails, busyArray }) => {
  return (
    <div className="min-w-[260px] shadeEffect flex flex-col bg-[#fcf8ff]  p-3 w-[95%] mx-[2.5%] rounded-lg justify-center  ">
      <div className="flex xs:flex-wrap justify-start  items-center gap-2 ">
        <img
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="flex  gap-1 font-poppins text-left ">
            Invitation Pending : <span className="font-bold text-red">{user.data.invitedProjectIds.length}</span>
          </p>
        </div>
      </div>
